...
export class UserAuthService {
   ...
   */
  public loginAsync(model: unknown): Observable<AuthUserModel> {
    // Ép kiểu vào LoginRequestModel để sử dụng đúng cấu trúc dữ liệu login.
    const loginModel = model as LoginRequestModel;
